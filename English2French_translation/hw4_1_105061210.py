...
class RNN(object):
    def __init__(self, n_words = 10000, seq_len = 120, cell_type = 'vanilla', hidden_size = 128, num_layers = 1, batch_size = 125, lr = 0.00075, embed_size = 256):
...
vanilla_rnn = RNN(hidden_size = 64, num_layers = 1, batch_size = 125, lr = 0.00075, embed_size = 256)


# In[8]:


train_loss, train_acc, test_loss, test_acc = vanilla_rnn.train(train_data, train_labels, test_data, test_labels, epochs = 10)
